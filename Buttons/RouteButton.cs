    ...
    public class RouteButton : CTCPButton {
        ...
        /*public override LightingType Lighting {
            get {
                ...
                var blinking = r.RouteState.R12 == RaiseDrop.Raise;
                var lighting = r.RouteState.R03 == RaiseDrop.Raise;
        ...
        public override bool OnClick() {
            ...
            if (CancelButton.Active) {
                ...
                HikipperButton.MakeInactive();
                if(TrainAlertManager.RemoveAlert(Route.RouteGroup, AlertType.Spawn)) {
