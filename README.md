...
### 管轄駅設定についてのご注意
**自分が操作するソフトから扱う駅以外は必ず全て管轄駅から外してください！**  
特に、他のシステムから扱われる駅を管轄駅とした場合、進行定位が正常に機能しないなど、意図しない動作の原因になります。  
...
さらに、**Ctrlキーを押した状態でCTCP画面上をドラッグ**して範囲選択し、そのままCキーを押すことで、選択した範囲のみのスクリーンショットをクリップボードにコピーできます。  
...
- **入線音**  
列車が停車場内に配置された際に使用される音の音量です。
- **下り接近音**  
下り列車が停車場に接近した際に使用される音の音量です。
- **上り接近音**  
上り列車が停車場に接近した際に使用される音の音量です。
- **接近警報音**  
列車が停車場に最接近した際に連続で鳴動する音の音量です。
...
**設定ファイルをカスタマイズすることで、本ソフトはあなただけのシステムとなるでしょう。**  
